                        ...
                        <div class="col-md-7 col-lg-8">
                            ...
                            <form class="needs-validation novalidate" name="formulario2" action="../ControladorLocal?accion=insertar" method="post">
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" class="form-control" name="nombreLocal" id="username" placeholder="Mi nombre de usuario" required>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="direccionLocal" id="adress" placeholder="C/ de la hostelería, 37" required>
                                    <div class="invalid-feedback">Por favor introduzca una dirección válida.</div>
                                </div>
                                <div class="col-12">
                                    <label for="Phone" class="form-label">Teléfono</label>
                                    <input type="text" class="form-control" name="telefonoLocal" id="phone" placeholder="600123456" required>
                                    <div class="invalid-feedback">Por favor introduzca un teléfono válido.</div>
                                </div>
                                <div class="col-12">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" class="form-control" name="emailLocal" id="email" placeholder="mi.correo@mail.com" required>
                                    <div class="invalid-feedback">Por favor introduzca un email válido.</div>
                                </div>
                                <div class="col-12">
                                    <label for="password" class="form-label">Contraseña</label>
                                    <input type="password" class="form-control" name="passwordLocal" id="password" placeholder="1234" required>
